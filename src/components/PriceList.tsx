...
export default function PriceList() {
  ...
  return (
    <section id="price-list" className="py-24 bg-bg-section scroll-mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {priceList.map((item, index) => (
            <ScrollReveal key={item.id} delay={index * 0.08}>
              <div className="bg-bg-card rounded-3xl p-8 border border-white/5 premium-card-shadow hover:premium-card-shadow-hover transition-all duration-500 hover:-translate-y-2 group flex flex-col justify-between h-full">
                <div>
                  {/* Icon Container */}
