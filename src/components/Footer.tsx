...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#060912] text-text-muted py-16 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pb-12 border-b border-white/5">
          {/* Left Column: Brand & Tagline */}
          <div className="space-y-4 text-center md:text-left">
            <a href="#home" className="inline-flex items-center space-x-2 group">
              <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center font-bold text-bg shadow-lg shadow-primary/20">
                BL
              </div>
            ...
            <p className="text-sm text-text-muted max-w-sm mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-end items-center gap-6">
            ...
            <a
              ...
              className="inline-flex items-center text-sm font-medium text-text-muted hover:text-white transition-colors duration-300 group"
            >
              <svg
                className="w-5 h-5 mr-2 text-text-dim group-hover:text-primary transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                viewBox="0 0 24 24"
        ...
        {/* Copyright */}
        <div className="pt-8 text-center text-xs text-text-dim flex flex-col sm:flex-row justify-between gap-4">
          <p>&copy; {currentYear} Bintang Laundry. All rights reserved.</p>
          <p className="flex items-center justify-center">
            Made with <span className="text-primary mx-1">&hearts;</span> in Bekasi, Jawa Barat
          </p>
        </div>
      </div>
    </footer>
