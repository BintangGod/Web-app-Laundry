    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center font-bold text-bg shadow-lg shadow-primary/20 group-hover:scale-105 transition-transform duration-300">
              BL
            </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-sm font-medium text-text-muted hover:text-primary transition-colors duration-300 relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-primary hover:after:w-full after:transition-all after:duration-300"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-10 h-10 rounded-xl text-text-muted hover:text-white bg-white/5 hover:bg-white/10 border border-white/5 hover:border-primary/30 transition-all duration-300 hover:-translate-y-0.5"
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-xl text-text-muted hover:text-primary hover:bg-white/5 focus:outline-none transition-colors duration-300"
      ...
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          isOpen ? "max-h-[28rem] border-t border-white/5 bg-bg/95 backdrop-blur-xl" : "max-h-0"
        }`}
        id="mobile-menu"
      >
        <div className="px-4 pt-3 pb-4 space-y-2">
          {navLinks.map((link) => (
            <a
              ...
              className="block px-4 py-2.5 rounded-xl text-base font-medium text-text-muted hover:text-primary hover:bg-white/5 transition-colors duration-300"
            >
              {link.name}
            </a>
          ))}
          <div className="pt-2 px-4 space-y-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center py-2.5 rounded-xl text-sm font-semibold text-text-muted hover:text-white bg-white/5 hover:bg-white/10 border border-white/5 transition-colors duration-300"
            >
